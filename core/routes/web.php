...
use App\Http\Controllers\APIs\MarketplaceAPIsController;
use App\Http\Controllers\Dashboard\EbayProductController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
//EBAY APIS
Route::get('/fetch-products', [MarketplaceAPIsController::class, 'fetchProducts']);
Route::get('/fetch-products-detail', [MarketplaceAPIsController::class, 'productsDetail']);
Route::get('/fetch-products-prices', [MarketplaceAPIsController::class, 'productsPrices']);
Route::get('/add-dummy-products-prices', [MarketplaceAPIsController::class, 'addDummyPrices']);
...
Route::get('/show-ebay-products', [EbayProductController::class, 'index'])->name('ebayproducts');
Route::get('/show-ebay-product-prices/{id}', [EbayProductController::class, 'showPrices'])->name('ebayproductPrices');
